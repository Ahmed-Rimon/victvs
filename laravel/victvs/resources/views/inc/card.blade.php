<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
    <template x-for="exam in filteredExams" :key="exam.id">
        <div @click="getSelectedExam(exam)" class="bg-white cursor-pointer  rounded-lg shadow-md p-4">

            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold mb-2" x-text="exam.Title"></h2>
                <div class="flex">
                  <button
                  ...
                  <button
                  @click.stop="openModal('edit', exam)"
            ...
            <p x-text="exam.Description"></p>
            <p x-text="exam.CandidateName"></p>
            <p x-text="exam.Date"></p>
            <p x-text="exam.LocationName"></p>
